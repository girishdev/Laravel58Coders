        ...
        <div class="col-12">
            <form action="/qanda" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="topic" id="topic" class="form-control">
                        ...
                        <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topicsValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($topicsValue); ?>"><?php echo e($topicsValue); ?></option>
                ...
                <div class="form-group">
                    ...
                    <select name="qtype" id="qtype" class="form-control">
                        ...
                        <?php $__currentLoopData = $qtype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qtypeValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($qtypeValue); ?>"><?php echo e($qtypeValue); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="question" name="question" value="<?php echo e(old('question') ?? $questions->question); ?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="link" value="<?php echo e(old('link') ?? $questions->link); ?>" class="form-control">
    ...
    <script>
        class MyUploadAdapter {
            ...
            _initRequest() {
                ...
                // could be different.
                xhr.open( 'POST', '<?php echo e(route('qanda.uploadimage')); ?>', true );
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Laravel58Coders/resources/views/QandA/create.blade.php ENDPATH**/ ?>