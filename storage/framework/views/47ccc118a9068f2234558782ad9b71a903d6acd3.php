...
<?php $__env->startSection('content'); ?>
    ...
    <?php $stats = app('App\QandA'); ?>
    <?php echo e($stats->lessons()); ?>

    <!-- Injecting Services with Blade -->

    <?php $__currentLoopData = $ajaxbasic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="pagination">
        <?php echo $ajaxbasic->render(); ?>

    </div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Laravel58Coders/resources/views/QandA/ajaxbasic.blade.php ENDPATH**/ ?>